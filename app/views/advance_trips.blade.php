...
function GetLocation() {
  ...
  <div class="container" style="width: 100%;">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class='input-group date' id='datetimepicker1'>
                    <input type='text' data-format="yyy-dd-mm HH:MM:ss" name="date" id="txtdate" class="form-control" />
      ...
      <div class="form-group" style="margin-top: 30px;"> 
        <input type="button" class="btn btn-success" value="Manual" onclick="advance_trip()" style="width: 100%;">
      </div>
...
<script>
  ...
  $.ajax({
           url: "{{ URL::Route('AdminAdvanceTrip') }}",
          type: "GET",
            data:{
