                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-push-2 clearfix">
                            <div class="section-heading scrollpoint sp-effect3">
                                ...
                                <span class="divider"></span>
                                <p>Explore the latest trends with the Cabrunz now features.</p>
                            </div>
                        </div>
                        <div class="col-md-12">
            ...
            <section id="settings">
                <div class="container">
                    <div class="col-md-7">
                        ...
                        <p class="first">Start your own Cabrunz app & dominate the on demand Cabrunz industry with the turn key app script. This app feeds you with an elegant Cabrunz booking app script, to immediately start up with your own business & use as turnkey which provides all the attributes to run the Cabrunz business which makes it a cake walk. By this you can enhance your business income in quick time frames using this app & make your journey of this Cabrunz business successful. So grab it soon.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="rights">
                                2015 <span><?= Config::get('app.website_title') ?></span> Developed by <a href="http://www.mowares.com"><span>Mowares</span></a> | <a href="{{route('termsncondition')}}"><span>Terms and Conditions</span></a>
                            </p>
                        </div>
                    </div>
                </div>
