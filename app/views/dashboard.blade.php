...
<?php $showDash = 0; $role_id = Auth::user()->role_id; $roleaction = RoleAction::where('role_id',Auth::user()->roles)->first();
    if($role_id == 0){ $showDash = 1; }else{ if($roleaction){ if($roleaction->dash == 1){ $showDash = 1; } } }
if($showDash == 1){ ?>
