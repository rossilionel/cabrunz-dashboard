...
@section('content')
                 ...
                 <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="model_no" value="" placeholder="Model No">
                                
                                        </div>

                                           <div class="form-group">
                                            <label>Vehicle No</label>
                                            <input class="form-control" type="text" name="vehicle_no" value="" placeholder="Vehicle No">
                            ...
                            <td>
                              <input class="form-control" name="service_base_price[<?php echo $types->id;?>]" type="text" value="" placeholder="Base Price" ><br>
                            </td>
                            <td>
                              <input class="form-control" name="service_price_distance[<?php echo $types->id;?>]" type="text" value="" placeholder="Price per unit distance" ><br>
                            </td>
                            <td>
                                <input class="form-control" name="service_price_time[<?php echo $types->id;?>]" type="text" value="" placeholder="Price per unit time" ><br>
                            </td>
                            </tr>
                               @endforeach
                            </tbody>
