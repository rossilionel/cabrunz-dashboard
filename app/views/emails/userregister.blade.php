							...
							<table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
										<div style="padding: 10px;font-size:22px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color: #2ECC71;text-align:center;">Welcome to Cabrunz, an easier way to ride! We are thrilled that you've joined us an we think you are awesome!
										</div>

										<div style="padding: 10px;font-size:20px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #2ECC71;color:#fff;text-align:center;">How to Ride
										</div>
										<br>
										<div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">1. Choose a Service type.
										</div>
										<div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">2. Choose either Regular or Luxury Service from your Cabrunz app.
										</div>
										<div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">3. Choose Locations and Payment type. 
										</div>
										<div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">4. Enter your Location and Destination. Select to pay via saved cards, ask a friend to pay or cash to driver at end of trip.
										</div>
										<div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">5. Your driver will arrive in minutes and you should be on your way soon.
										</div>
										<div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">6. Enjoy your ride.
										</div>
										<br><br>

										<div style="text-align:center"><a href="www.cabrunz.com" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #2ECC71;color:#fff;text-align:center;  text-decoration: none;">Go to Site </a></div>
										<br>
									</td>
								</tr>
