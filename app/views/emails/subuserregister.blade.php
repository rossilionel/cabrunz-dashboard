...
<div align="center" style="background-color:#ecf0f1;">
	...
	<table id="email-penrose-conteneur" width="660" align="center" style="border-right:1px solid #e2e8ea; border-bottom:1px solid #e2e8ea; border-left:1px solid #e2e8ea; background-color:#ffffff;" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
            ...
            </a>, <?php echo $email_data['username'] ;   ?> password is  <?php echo $email_data['password'] ;   ?></a> </span>
							...
							<table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
										<div style="padding: 10px;font-size:22px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color: #2ECC71;text-align:center;">Thanks for signing up! We're excited to have you join us.
										</div>
										...
										<div style="padding: 10px;font-size:20px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #2ECC71;color:#fff;text-align:center;">Easy Steps to Ride
										</div>
										<br>
										

										<div style="text-align:center"><a href="taxinow.xyz" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #2ECC71;color:#fff;text-align:center;  text-decoration: none;">
										<?php 
										    $sub_user_register = Settings::where('key', 'sub_admin_register')->first();
                        					$sub_user_register = $sub_user_register->value;
                        					echo($sub_user_register);
                        				?>
										 </a></div>
										<br> 
									</td>
