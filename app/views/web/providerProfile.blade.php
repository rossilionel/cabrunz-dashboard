            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="col-sm-4">
                        ...
                        $servname = $types->name;
                        ?>
                        <input id="service" name="service[{{$i}}]" type="checkbox" value="{{$types->id}}" <?php
                        if (!empty($ar)) {
                    ...
                    <div class="col-sm-2">
                        <input id="base_price" name="service_base_price[{{$i}}]" type="text" value="<?php
                        $proviserv = ProviderServices::where('provider_id', $user->id)->where('type', $types->id)->first();
                        if (empty($proviserv)) {
                            echo "";
                        } else {
                            echo $proviserv->base_price;
                        }
                        ?>" placeholder="Base Price" >
                        <br>
                    </div>
                    <div class="col-sm-2">
                        <input id="distance_price" name="service_price_distance[{{$i}}]" type="text" value="<?php
                        $proviserv = ProviderServices::where('provider_id', $user->id)->where('type', $types->id)->first();
                        if (empty($proviserv)) {
                            echo "";
                        } else {
                            echo $proviserv->price_per_unit_distance;
                        }
                        ?>" placeholder="Price per unit distance" >
                        <br>
                    </div>
                    <div class="col-sm-2">
                        <input id="time_price" name="service_price_time[{{$i}}]" type="text" value="<?php
                        $proviserv = ProviderServices::where('provider_id', $user->id)->where('type', $types->id)->first();
                        if (empty($proviserv)) {
                            echo "";
                        } else {
                            echo $proviserv->price_per_unit_time;
                        }
